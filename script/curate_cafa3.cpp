...
"curate_cafa3 uniprot_sprot_exp.txt uniprot_sprot_exp alt_id.csv is_a.csv\n"
"    generate compact format go annotation\n"
"\n"
"Input:\n"
"    uniprot_sprot_exp.txt - CAFA3 format GO annotation in the following format\n"
"                             [1]  DB Object ID\n"
"                             [2]  GO ID\n"
"                             [3]  Aspect\n"
...
void curate_cafa3(const string &inputfilename, vector<string>&accession_list,
...
int main(int argc,char **argv)
{
    ...
    map<string, map<string, vector<string> > > GAF_dict;
    map<string, vector<string> > tmp_dict;
    curate_cafa3(inputfilename,accession_list,Aspect_list,
